...
| 2026-04-26 | Dashboard tiles stay read-only in Phase B | B.7 provides situational awareness from existing read models and tables, without creating new review items or write-side jobs. Stalled Candidates is a heuristic count, not the Phase E auto-stall workflow. Contradictions counts existing contradiction-type review items, not yet-to-be-built Phase C contradiction detection output. |
