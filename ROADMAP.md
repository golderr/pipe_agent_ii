...
| D.5 | Article review queue | `not_started` | Extracted findings should be surfaced as review items, not auto-applied. Researcher confirms: "yes, this article is about project X and says Y." **Blocked on C.tail.11/12** — articles fold into existing decision cards as supporting or against evidence under the consolidated card shape; no separate UI shape needed once C.tail.12 lands. |
