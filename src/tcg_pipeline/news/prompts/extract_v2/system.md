...
- Use candidate_stories only when the article directly states the building height in stories or floors. Do not infer stories from height in feet, zoning, renderings, podium levels, or parking levels unless the article explicitly counts them as stories.
