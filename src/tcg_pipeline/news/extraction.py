...
EXTRACT_RETRY_TRIGGER_STATUSES = frozenset(
    {
...
def run_news_extraction_for_article(
    ...
    *,
    ...
    from tcg_pipeline.news.extraction_legacy import (
        maybe_run_pass3a_reextraction,
        merge_pass3a_result,
    )

    pass3a_result = maybe_run_pass3a_reextraction(
        article_id=article_id,
        prior_result=result,
        client=extraction_client,
        session_factory=resolved_session_factory,
    ...
    if pass3a_result is None:
        return result
    return merge_pass3a_result(result, pass3a_result)
